/**
 * When defining a new variable here you must also declare it in the 
 * typings.d.ts file so Typescript knows about it.
 *
 * Should we take this opportunity to name these variables better? (i.e. not beginning with __)
 */
