...
describe('Authentication Router Guard', () => {
  describe('Cookie updated', () => {
    beforeEach(
      async(() => {
        TestBed.configureTestingModule({
          providers: [{ provide: AuthService, useClass: StubAuthService }, CanActivateViaAuth]
        });
      })
    );
    ...
    it(
      ...
      inject([CanActivateViaAuth, AuthService], (canActivate: CanActivateViaAuth, stubAuthService: AuthService) => {
  ...
  describe('Cookie Expired', () => {
    beforeEach(
      async(() => {
        TestBed.configureTestingModule({
          providers: [{ provide: AuthService, useClass: StubNonAuthService }, CanActivateViaAuth]
        });
      })
    );
